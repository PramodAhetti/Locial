...
export default function homeLayout({children,}:{children: React.ReactNode}) {
    ...
    const submitPost=async ()=>{
      ...
      let autherId=await axios.post('/api/users/new',{email:user.data?.user?.email});
      autherId=autherId.data.data?.id
      const result=await axios.post('/api/post/new',{autherId,message,location}) 
