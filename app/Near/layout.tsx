...
export default function homeLayout({children,}:{children: React.ReactNode}) {
   ...
   return (
      <div className='h-screen  w-full grid grid-cols-12 bg-zinc-800 grid-rows-12'>
        ...
        <input placeholder="Enter a post" ref={post} className="p-2 w-5/6 bg-white border text-black border-black row-start-12 row-end-13 col-start-1 col-end-12 rounded-md"></input> 
        <SendHorizonal onClick={submitPost} className="text-white w-8 h-8 row-start-12 row-end-13 col-start-12 col-end-13"></SendHorizonal>
        </div>
      </div>
    )
  }